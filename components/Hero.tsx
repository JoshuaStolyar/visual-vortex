        ...
        <div className="max-w-5xl mx-auto space-y-9">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-5">
            <a
              ...
              className="px-9 py-4 bg-blue-600 text-white rounded-lg font-semibold text-lg hover:bg-blue-700 transition-all duration-200 shadow-sm hover:shadow-md"
            >
              Apply to Work Together
            </a>
            <a
              href="#portfolio"
              className="px-9 py-4 border-2 border-gray-200 text-gray-900 rounded-lg font-semibold text-lg hover:border-gray-300 hover:bg-gray-50 transition-all duration-200"
            >
              Portfolio
            </a>
          </div>
          ...
          {/* Stats - Clean Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-7 max-w-4xl mx-auto pt-8">
            <div className="p-11 rounded-2xl border-2 border-gray-200 bg-white shadow-lg hover:shadow-xl hover:border-blue-300 transition-all duration-300 group">
              <div className="pr-4">
                <AnimatedCounter
                  end={250}
                  suffix="M+"
                  className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 text-transparent bg-clip-text mb-3 tabular-nums"
                />
              </div>
